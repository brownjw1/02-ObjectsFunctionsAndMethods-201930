...
def try_methods_and_functions():
    ...
    ###########################################################################
    turtGuy = rg.SimpleTurtle()
    turtGuy.pen = rg.Pen('blue', 5)
    turtGuy.forward(150)
    turtGuy.speed=1
    draw_many_squares(turtGuy, 2, 100, 15)
    turtGuy.speed=5
    turtGuy.pen.color='red'
    draw_many_squares(turtGuy, 10, 50, 15)
    turtGuy.speed=100
    turtGuy.pen.thickness=35
    draw_many_squares(turtGuy, 8, 300, 60)
    turtGuy.pen=rg.Pen('black',3)
    turtGuy.backward(200)
    turtGuy.draw_circle(30)
    turtGuy.draw_square(50)
